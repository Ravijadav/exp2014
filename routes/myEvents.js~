  ...
  consumer.count({userName:user},function(err,count){
    ...
    if(count==0){
          res.send("<h1>User does not exist</h1>"+
                "<a href='http://52.74.104.128:3000'>Please signin to avail Services</a>");
  }
          ...
          $ = cheerio.load("<!DOCTYPE html> "
                  ...
                  "      <div class='col-md-2'>"+
                  "        <br>"+
                  "       <form  action='http://52.74.104.128:3000' enctype='application/x-www-form-urlencoded'>"+
                  "           <button name='Logout' type='submit' class='btn btn-info'>Logout</button>" +
                  "       </form>"+
                  "       </div>"+
                  "    </div>"+
                  ...
                  + "<div class='row'>"
                  + "    <form action='http://52.74.104.128:3000/allInterestsAllLocations'>"
                  + "        <div class='col-md-3' align='center'>"    
                  + "           <button name='searchEvents' type='submit' class='btn btn-info'>Update Interest</button>"
                  //+   "              <a href='http://52.74.104.128:3000'><button type='submit' class='btn btn-info' value='Logout'>Update Interest</button></a>"+ 
                  + "         </div>"
 ...
 if(err){console.log(err)}
    ...
    if(password!=interests[0].password){
        res.send("<h1>OOPS!Password seems to be mismatched</h1>"+
                "<a href='http://52.74.104.128:3000'>Please login again</a>");   
    }
    ...
    provider
        ...
        var link="http://52.74.104.128:3000/providers/";	
        ...
        $("#allEvent1").attr("href","http://52.74.104.128:3000/viewAllHappenings/"+interest1+"/"+user+"/"+consumerLocation);
        $("#nearEvent1").attr("href","http://52.74.104.128:3000/viewAllHappenings/"+interest1+"/"+user+"/"+nearestLocation);
            ...
            $("#allEvent2").attr("href","http://52.74.104.128:3000/viewAllHappenings/"+interest2+"/"+user+"/"+consumerLocation);
   					$("#nearEvent2").attr("href","http://52.74.104.128:3000/viewAllHappenings/"+interest2+"/"+user+"/"+nearestLocation);
   	    ...
   	    if(providers2[0].category=='music'){
            ...
            $("#allEvent3").attr("href","http://52.74.104.128:3000/viewAllHappenings/"+interest3+"/"+user+"/"+consumerLocation);
   			    $("#nearEvent3").attr("href","http://52.74.104.128:3000/viewAllHappenings/"+interest3+"/"+user+"/"+nearestLocation);
