...
provider.find({eventName:eventName},function(err,eventDetail){
    ...
    // console.log(eventDetail);
    	 ...
    	 $ = cheerio.load("<!DOCTYPE html> " +
          ...
          "                 <div class='col-md-2'>"+
          "                     <br>"+
          "                       <a href='http://52.74.104.128:3000'><input type='button' class='btn btn-info' value='Logout'></a>"+
          "                 </div>"+
          "              </div>"+        
      ...
      "</html>");
       ...
       $('#form_id').attr({"action":"http://52.74.104.128:3000/providers/comments/"+eventDetail[0].eventName+"/"+user,
                            "method":"post"});
