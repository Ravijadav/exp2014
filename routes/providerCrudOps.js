...
provider.find({eventName:eventName},function(err,eventDetail){
     ...
     mongoose.disconnect(function(err){if(err){console.log(err)}
    	 ...
    	 $ = cheerio.load("<!DOCTYPE html> " +
          ...
          "                 <div class='col-md-2'>"+
          "                     <br>"+
          "                       <a href='http://project-939413137.ap-southeast-1.elb.amazonaws.com'><input type='button' class='btn btn-info' value='Logout'></a>"+
          "                 </div>"+
          "              </div>"+        
      ...
      "</html>");
       ...
       $('#form_id').attr({"action":"http://project-939413137.ap-southeast-1.elb.amazonaws.com/providers/comments/"+eventDetail[0].eventName+"/"+user,
                            "method":"post"});
